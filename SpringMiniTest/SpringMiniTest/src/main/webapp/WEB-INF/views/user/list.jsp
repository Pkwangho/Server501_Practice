        ...
        <div class="row">
            <div class="col">
                <nav class="navbar navbar-expand-lg bg-body-tertiary">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="/user/list">목록가기</a>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="/user/list" method="get">
                            ...
                            <div class="mb-3">
                                <input type="checkbox" name="finished2" ${pageRequestDTO.finished ?"checked":""}> 완료여부
                            </div>
                            <div class="mb-3">
                                <input type="checkbox" name="types" value="t" ${pageRequestDTO.checkType("t")?"checked":""}>이름
                                <input type="checkbox" name="types" value="w" ${pageRequestDTO.checkType("w")?"checked":""}>패스워드
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <c:forEach items="${pageResponseDTO.dtoList}" var="dto">
                                <tr>
                                    <th scope="row"><c:out value="${dto.uno}"></c:out></th>
                                    <td><a href="/user/read?uno=${dto.uno}&${pageRequestDTO.link}"
